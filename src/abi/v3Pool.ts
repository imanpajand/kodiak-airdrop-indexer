...
export const events = {
    ...
    ProtocolFeesEarned: event("0xb4531bf5205d5c6c7af96c068df3ed1283b18a08e6ccf082a4333d7104705b6a", "ProtocolFeesEarned(uint128,uint128)", {"amount0": p.uint128, "amount1": p.uint128}),
...
export type ProtocolFeesEarnedEventArgs = EParams<typeof events.ProtocolFeesEarned>
